...
- 更新 `宽幅知识插画信息图生成器` 为 V1.1 极简插画版，图片署名调整为 `姚金刚`。
- 新增 `宽幅知识插画信息图生成器` 中英文提示词，放入 `AI内容/内容工具`，并更新目录、首页与网页统计。
- 将 `prompts-en/` 扩展为完整英文镜像，117 个中文提示词均已有同路径英文对应文件。
...
- 更新 README、Prompts 说明、分类体系、全量目录和网页导航，中文提示词总数更新为 117 个。
